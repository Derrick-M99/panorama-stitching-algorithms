...
img1 = cv2.imread('IMG_7984.jpg', cv2.IMREAD_COLOR)
img2 = cv2.imread('IMG_7985.jpg', cv2.IMREAD_COLOR)
img3 = cv2.imread('IMG_7986.jpg', cv2.IMREAD_COLOR)
...
# Perform stitching with OpenCV's Stitcher
